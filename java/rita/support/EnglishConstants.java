...
public interface EnglishConstants {
  ...
  RegexRule NULL_PLURALS = new RegexRule(
      ...
      + "gabonese|gauze|glucose|grease|guyanese|haze|incense|japanese|javanese|journalese|"wq
      + "lebanese|malaise|manganese|mayonnaise|maltese|menopause|merchandise|nitrocellulose|olympics|"
      + "overuse|paradise|poise|polymerase|portuguese|prose|recompense|remorse|repose|senegalese|siamese|singhalese|innings|"
  ...
  FinalSet<String> categorySE_SES = new FinalSet<String>(
    "abuses", "apocalypses", "blouses", "bruises", "chaises","cheeses",
   "chemises", "clauses", "corpses", "courses", "crazes","creases",
   "cruises", "curses", "databases", "dazes", "defenses", "demises",
   "discourses", "diseases", "doses","eclipses", "enterprises","expenses",
   "friezes", "fuses", "glimpses", "guises", "hearses", "horses", "houses",
   "impasses", "impulses", "kamikazes", "mazes","mousses","noises", "nooses",
   "noses", "nurses", "obverses", "offenses", "overdoses", "phrases", "posses",
   "premises", "pretenses", "proteases", "pulses",  "purposes", "purses",
   "racehorses", "recluses","recourses", "relapses", "responses", "roses",
   "ruses", "spouses", "stripteases", "subleases", "sunrises", "tortoises",
